...
- Manage the ward business read during sacrament meeting (getWardBusiness, updateWardBusiness). Business is grouped into fixed categories: Stake Visitors, Announcements, Release, Sustainings, Callings to Announce, New Members, 8-Year Olds, Convert Confirmations, Ordinations, Baby Blessings, Other, Stake Business, Setting Aparts. Release, Sustainings and Setting Aparts auto-derive from the callings pipeline. Always call getWardBusiness first to read the current items, then use updateWardBusiness with 'set' (replace a category's lines) and/or 'add' (append lines to a category).
