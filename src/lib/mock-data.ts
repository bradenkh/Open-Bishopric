...
export const MOCK_CALLINGS: Calling[] = [
  // ── Releases (outgoing holders) + their linked fill cards ───────────────────
  // Andrew is being released; the replacement search is a separate fill card.
  {
    id: "c00a",
    kind: "release",
    linkedId: "c00a-fill",
  ...
  },
  {
    ...
    organization: "Elders Quorum",
    stage: "vacant",
    releasedName: "Andrew Olson",
    suggestedReplacements: ["David Park", "Thomas Hughes"],
    createdBy: "mock-bishop-001",
    createdAt: "2026-06-01T00:00:00Z",
    updatedAt: "2026-06-01T00:00:00Z",
  },
  // Richard has been informed; release awaiting its sacrament-meeting announcement.
  {
    id: "c00b",
    kind: "release",
    linkedId: "c00b-fill",
    ...
    businessItemAdded: false,
    releasedBy: "Counselor Hughes",
